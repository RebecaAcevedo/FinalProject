...
finalcounts <- read.table("counts.txt", sep="\t", header=TRUE)
dim(finalcounts)
head(finalcounts, 10)
View(finalcounts)
...
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349741_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.1"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349742_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.2"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349743_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.3"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349744_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.4"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349745_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.5"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349746_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.6"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349747_Aligned.sortedByCoord.out.bam"] ="Tumor_sample.7"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349748_Aligned.sortedByCoord.out.bam"] ="Non.tumor_sample.1"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349749_Aligned.sortedByCoord.out.bam"] ="Non.tumor_sample.2"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349750_Aligned.sortedByCoord.out.bam"] ="Non.tumor_sample.3"
names(final.count.table)
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349751_Aligned.sortedByCoord.out.bam"] ="Non.tumor_sample.4"
colnames(final.count.table)[colnames(final.count.table) == "X.xdisk.guangyao.416a516a.Group15.Rebeca.STAR.SRR349752_Aligned.sortedByCoord.out.bam"] ="Non.tumor_sample.5"
...
row.names(final.count.table) <- finalcounts$Geneid  #row.names(): gets/sets row names (vector) of a data frame
...
mat_DEgenes <- Final_rlog.counts[DEgenes, c('Tumor_sample','Non.tumor_sample)]
